...
query = """
select Year, Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, December from MRTS_data_consolidated where NAICSCode = 45112 and Data_type = 'Unadjusted' AND Year BETWEEN 1992 AND 2020 order by Year ;"""
try:
...
df_pruned.rename(columns = {'Value':'HobbyStores'}, inplace=True)
print(df_pruned.head())
output_file = "/Users/rkprabhu/Downloads/HobbyStores10.csv" 
